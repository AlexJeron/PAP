<div class="modal fade" id="editTurma" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input id="name" type="text" class="form-control @error('nome') is-invalid @enderror"
                                name="nome" value="{{ $turma->nome }}" maxlength="80" autofocus required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input id="email" type="text" class="form-control @error('email') is-invalid @enderror"
                                name="email" value="{{ $turma->nome }}" maxlength="80">
