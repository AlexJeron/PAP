            ...
            <div class="modal-body">
                <form id="form_atividade" name="form_atividade">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input id="name" type="text" class="form-control form-show" name="name" maxlength="80"
                                disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control form-show" id="local" name="local" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input id="inicio" type="datetime-local" class="form-control form-show" name="inicio"
                                disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 pl-0">
                            <input id="outros_espectadores" type="text" class="form-control form-show"
                                name="outros_espectadores" placeholder="Sem outros possíveis espectadores"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input id="turmas" type="text" class="form-control form-show" name="turmas"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input id="professores" type="text" class="form-control form-show" name="professores"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-1">
                            <input id="total_recursos" type="number" min="1" class="form-control form-show"
                                name="total_recursos" placeholder="0" disabled>
                        </div>

                        <div class=" col-sm-9 pl-0">
                            <input id="nome_recurso" type="text" class="form-control form-show" name="nome_recurso"
