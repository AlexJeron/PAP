...
(function(global, factory) {
      ...
      if (buttonStr) {
        buttonStr.split(' ').forEach(function(buttonGroupStr, i) {
          ...
          buttonGroupStr.split(',').forEach(function(buttonName, j) {
            ...
            var buttonAriaAttr;
            if (buttonName === 'title') {
              groupChildren.push(htmlToElement('<h2 id="calendar_title">&nbsp;</h2>')); // we always want it to take up height
              isOnlyButtons = false;
            } else {
  ...
  var View = /** @class */ (function(_super) {
    ...
    function View(viewSpec, parentEl) {
      var _this =
        _super.call(this, createElement('div', { className: 'fc-view fc-' + viewSpec.type + '-view' })) || this;
  ...
  var DayHeader = /** @class */ (function(_super) {
    ...
    DayHeader.prototype.render = function(props, context) {
      ...
      var colHeadFormat = createFormatter(
        context.options.columnHeaderFormat || computeFallbackHeaderFormat(datesRepDistinctDays, dates.length),
      );
